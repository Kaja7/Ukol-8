...
const objednatJustFood = (pocetLidi) => {
	return `catering od Just Food pro ${pocetLidi} lidí za ${Math.round(
		pocetLidi * 120
	)} Kč`
}
const objednatYourMama = (pocetLidi) => {
	return `catering od Your Mama pro ${pocetLidi} lidí za ${Math.round(
		pocetLidi * 550
	)} Kč`
}
const objednatFlavourHaven = (pocetLidi) => {
	return `catering od Flavour Haven pro ${pocetLidi} lidí za ${Math.round(
		pocetLidi * 2500
	)} Kč`
}

console.log(objednatJustFood(20))

console.log(objednatYourMama(5))

console.log(objednatFlavourHaven(2))

/*const createEvent ("svatba", 50, objednatYourmama) {
